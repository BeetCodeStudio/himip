...
<!-- Main Content -->
    <!-- foto pengurus -->
    <div class="h-[40rem] bg-cover bg-bottom bg-fixed" style="background-image: url('himipcandradimuka.jpg');">
        <div
            class="top-0 left-0 h-full w-full flex flex-col items-center justify-center space-y-3 text-white text-center bg-slate-600/80">
            <p class="text-5xl font-extrabold font-poppins">HIMIP FISIP UNRI 2022</p>
    ...
    <!-- about himip -->
    <div class="container  mx-auto py-10 md:py-20 flex flex-col">
        <div class="grid grid-cols-1 md:grid-cols-2">
            <div
                class="space-y-5 text-center md:text-left order-3 md:order-2 items-center justify-center flex flex-col">
    ...
    <div class="container ">
        <div class="rounded-md border-2 border-gray-300 bg-slate-100 p-5">
            <iframe class="w-full h-full aspect-video" src="https://www.youtube.com/embed/KtODBLuG5gU"
    ...
    <section class="container flex flex-col items-center text-center py-5">
        ...
        <div class="w-full grid grid-cols-1 md:grid-cols-2">
            <div class="bg-black rounded-t-md md:rounded-none md:rounded-l-md shadow-md h-full w-full pt-3 mb-5">
                <img class="lg:h-48 md:h-36 h-40 w-full object-cover object-center"
                src="https://source.unsplash.com/random" alt="">
            </div>
            <div
                class="bg-slate-100 p-10 rounded-b-md md:rounded-none md:rounded-r-md border-2 border-gray-300 text-zinc-900 flex flex-col space-y-3 justify-center text-center md:text-left w-full font-semibold">
                ...
                <h2 class="text-2xl font-semibold capitalize">
                    Kelas jurnalistik tingkat dasar
                </h2>
                <ul class="font-normal leading-relaxed text-justify">
                    <p>
                        "Menumbuhkan semangat jurnalis yang akurat dan anti hoax"
                    </p>
                    <li>
                        🗓️ Hari/ tanggal : Minggu/ 20 Maret 2022
                    </li>
                    <li>
                    ...
                    <li>
                        🗣️ Pemateri : Febrina Wulandari
                    </li>
                </ul>
                <a href="" class=" hover:text-blue-900 inline-flex justify-center md:justify-start items-center">Read
                    More
                ...
                <div class="text-center mt-2 leading-none flex justify-center w-full py-4">
                    <span
                        class=" mr-3 inline-flex items-center leading-none text-sm pr-3 py-1 border-r-2 border-gray-200">
        ...
        <a href="upcomingevent.html" class="button-min">
            See More
        </a>
    </section>
    <!-- upcoming end -->
    ...
    <section class="container flex flex-col items-center text-center py-5">
        ...
        <a href="pressrelease.html" class="button-min">
            See More
        </a>
    </section>
    <!--  pressrealese -->
    ...
    <section class="container text-gray-600 body-font">
        <div class=" pb-5">
            ...
            <div class="flex flex-wrap -m-4">
                ...
                <div class="p-4 md:w-1/3">
                    <div
                    class="h-full bg-white border-2 border-gray-300  rounded-lg overflow-hidden">
                    <img class="lg:h-48 md:h-36  h-40 w-full object-cover object-center"
        ...
        <div class="w-full text-center py-5">
            <a href="articles.html" class="button-min">
                See More
            </a>
        </div>
    </section>
    ...
    <div class="container ">
        ...
        <iframe src="https://open.spotify.com/embed-podcast/episode/06kX4u0WKge8I7fcUNkj7f" width="100%" height="232"
        ...
        <div class="grid items-center md:items-start w-full grid-cols-1 md:grid-cols-3 gap-5">
            <div class="flex flex-col gap-5">
                ...
                <div class="flex items-center gap-5">
                    ...
                    <p class="text-black font-semibold hover:text-blue-800">Alamat </p>
                </div>
            </div>
            <div class="space-y-5">
