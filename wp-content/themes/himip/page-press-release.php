<?php get_header(); ?>
    ...
    <!-- Main Content -->
    <div class="bg-blue-50 text-center py-20 mb-10">
        <h2 class="title capitalize py-3">Press Realese</h2>
        <p class="petunjuk capitalize">event yang sudah dilaksanakan</p>
    </div>
...
<section class="container text-gray-600 body-font">
    <div class=" pb-5">
        <div class="flex flex-wrap -m-4">
            <?php
            query_posts('category_name=press-release&showposts=9');
