<?php get_header(); ?>
    ...
    <div class="bg-blue-50 text-center py-20">
        <h2 class="title capitalize py-3">Profil Dosen Ilmu Pemerintahan</h2>
        <p class="petunjuk capitalize"> dosen ilmu pemerintahan FISIP UNRI</p>
    </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3">
            ...
            <div class="p-4">
                ...
                <div
                    ...
                    <div class="text-center flex-1">
                        <p class="font-semibold text-lg">Pendidikan</p>
                        <p>S1 - Universitas Riau</p>
                        <p>S2 - Universitas Gajah Mada</p>
                        <p>S3 - Universitas Padjajaran</p>
                        <p>S3 - Universitas Padjajaran</p>
                    </div>
                    <div class="text-center flex-1">
                        <p class="font-semibold text-lg">Kontak</p>
            ...
            <div class="p-4">
                <div class="h-full space-y-3 py-5 px-3 flex flex-col justify-between items-center bg-slate-100 rounded-md border-2 border-gray-300 ">
                    ...
                    <div class="text-center">
                        <p class="font-semibold text-lg">Pendidikan</p>
                        <p>S1 - Universitas Riau Kepulauan</p>
                        <p>S2 - Universitas Riau</p>
                    </div>
                    <div class="text-center flex-1">
                        <p class="font-semibold text-lg">Kontak</p>
            ...
            <div class="p-4">
                <div class="h-full space-y-3 py-5 px-3 flex flex-col justify-between items-center bg-slate-100 rounded-md border-2 border-gray-300 ">
                    ...
                    <div class="text-center">
                        ...
                        <p>S1 - Universitas Riau</p>
                        <p>S2 - Universitas Riau</p>
                        <p>S3 - Universitas Muhammadiyah Yogyakarta </p>
                    </div>
                    <div class="text-center flex-1">
                        <p class="font-semibold text-lg">Kontak</p>
                        <p>081365142852</p>
            ...
            <div class="p-4">
                <div class="h-full space-y-3 py-5 px-3 flex flex-col justify-between items-center bg-slate-100 rounded-md border-2 border-gray-300 ">
                    ...
                    <div class="text-center">
                        <p class="font-semibold text-lg">Pendidikan</p>
                        <p>S1 - Universitas Airlangga</p>
                        <p>S2 - Universitas Airlangga</p>
                    </div>
                    <div class="text-center flex-1">
                        <p class="font-semibold text-lg">Kontak</p>
                        <p>081249249520</p>
            ...
            <div class="p-4">
                <div class="h-full space-y-3 py-5 px-3 flex flex-col justify-between items-center bg-slate-100 rounded-md border-2 border-gray-300 ">
                    <img src="<?php echo  bloginfo('template_directory').'/img/dosen' ?>/3.-Dr.-Muchid-S.Sos-M.Phil_.png" class="w-30 h-40" alt="">
    
                    <p class="text-center font-semibold font-poppins text-lg capitalize flex-1">Dr. Muchid, M.Phil

                    </p>
                    <div class="text-center">
                        <p class="font-semibold text-lg">Pendidikan</p>
                        <p>S1 - Universitas Riau</p>
                        <p>S2 - Universitas Kebangsaan Malaysia</p>
                        <p>S3 - Universitas Kebangsaan Malaysia</p>
            ...
            <div class="p-4">
                <div class="h-full space-y-3 py-5 px-3 flex flex-col justify-between items-center bg-slate-100 rounded-md border-2 border-gray-300 ">
                    <img src="<?php echo  bloginfo('template_directory').'/img/dosen' ?>/3.-DR.-Khairul-Anwar-M.si_.png" class="w-30 h-40" alt="">
    
                    <p class="text-center font-semibold font-poppins text-lg capitalize flex-1">Dr. Khairul Anwar, M.Si
            ...
            <div class="p-4">
                <div class="h-full space-y-3 py-5 px-3 flex flex-col justify-between items-center bg-slate-100 rounded-md border-2 border-gray-300 ">
                    <img src="<?php echo  bloginfo('template_directory').'/img/dosen' ?>/Dr. HASANUDDIN, M.Si.jpg" class="w-30 h-40" alt="">
    
                    <p class="text-center font-semibold font-poppins text-lg capitalize flex-1">Dr. HASANUDDIN, M.Si

                    </p>
                    <div class="text-center">
                        <p class="font-semibold text-lg">Pendidikan</p>
                        <p>S1 - Universitas Hasanuddin</p>
                        <p>S2 - Universitas Gajah Mada </p>
                        <p>S3 - Universitas Gajah Mada </p>
                    </div>
                    <div class="text-center flex-1">
